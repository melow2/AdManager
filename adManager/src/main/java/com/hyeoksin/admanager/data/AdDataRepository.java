...
public class AdDataRepository implements AdDataSource {
    ...
    public AdDataRepository(@Nullable String baseUrl) {
        if (baseUrl != null) {
            // http://52.78.108.217/AdManager/interstitial.json
        ...
        if (adApi != null) {
            adApi.getAds(endUrl).enqueue(new Callback<List<Ad>>() {
                ...
                public void onResponse(@NonNull Call<List<Ad>> call,
                    ...
                    Log.d(AdManager.TAG, "#0 [ RESPONSE_URL_SUCCESS ] - CURRENT_TIME_MILLIS: " + String.valueOf((endTime - startTime)/1000)+"초");
                ...
                public void onFailure(@NonNull Call<List<Ad>> call,
                    ...
                    if(AdManager.TEST) {
                        ...
                        Log.d(AdManager.TAG, "#0 [ RESPONSE_URL_FAILURE ] - CURRENT_TIME_MILLIS: " + String.valueOf((endTime - startTime)/1000)+"초");
                    }
